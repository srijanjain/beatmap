...
function loadDemo(which) {
  switch(which) {
    case 1:
      board.data = decode('&100');
      break;
    case 2:
      board.data = decode('&100');
      break;
    case 3:
      board.data = decode('&100');
      break;
    case 4:
      ...
      break;
    case 5: 
      board.data = decode('&100');
      break;
  }
  updateLocation();
  board.draw();
