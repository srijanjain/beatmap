    ...
    function (position) {
      ...
      loadPlaces(position.coords).then((places) => {
        places.forEach((place) => {
          ...
          text.setAttribute(
            "href",
            "https://srijanja.in/beatmap/beatbuilder/#&100"
          );
