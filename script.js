    ...
    function (position) {
      ...
      loadPlaces(position.coords).then((places) => {
        places.forEach((place) => {
          ...
          text.setAttribute(
            "href",
            "https://srijahttps://srijanja.in/beatmap/beatbuilder/#&100nja.in/beatmap/beatbuilder/"
          );
